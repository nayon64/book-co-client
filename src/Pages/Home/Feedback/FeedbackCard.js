...
const FeddbackCard = ({ feedback }) => {
    ...
    <div className=" flex">
      ...
      <div className="ml-3 p-6  w-4/6 -mt-12 pr-12 ">
        <div className='flex flex-col justify-center  h-full'>
          <h2 className="text-4xl font-bold text-white border-l-8 pl-8 py-4 border-red-500">
            {feedback?.title}
          </h2>
          <p className='pl-12 py-8 text-gray-300 text-xl font-sm'>{feedback?.message}</p>
          <div>
